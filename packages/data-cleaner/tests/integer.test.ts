...
t.test("reject string", async (t) => {
	t.rejects(clean.integer()("test"), new ValidationError("Invalid value."))
})

t.test("reject boolean", async (t) => {
	t.rejects(clean.integer()(true), new ValidationError("Invalid value."))
})

t.test("reject object", async (t) => {
	t.rejects(clean.integer()({}), new ValidationError("Invalid value."))
})
...
t.test("Empty values", async (t) => {
	await t.test("reject undefined", async (t) => {
		t.rejects(clean.integer()(), new ValidationError("Value required."))
	})
	...
	await t.test("reject null", async (t) => {
		t.rejects(clean.integer()(null), new ValidationError("Value required."))
	})
